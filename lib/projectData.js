...
import { developers } from './propertyData';
...
export const featuredProperties = [
    {
        ...
        type: 'Apartment',
        status: 'Ready',
        coordinates: { lat: 25.189, lng: 55.276 },
      ...
      },
      {
        ...
        status: 'Off Plan',
        coordinates: { lat: 25.195, lng: 55.27 },
        ...
        faqs: [
          {
            question: 'What is the payment plan for this project?',
            answer: 'The payment plan is typically structured as 20% on booking, 60% during construction, and 20% on handover. Please register your interest for exact details.'
          },
          {
            question: 'Is there a show apartment available to view?',
            answer: 'Yes, show apartments are available for viewing. Please contact us to schedule an appointment.'
          },
          {
            question: 'What are the expected service charges?',
            answer: 'The estimated service charges are between AED 18-22 per sq. ft. This is subject to change upon project completion.'
          },
          {
            question: 'Can foreigners buy property in this area?',
            answer: 'Yes, this project is located in a freehold area, which means foreign nationals can purchase property with 100% ownership.'
          }
        ],
        usp: [
            {
      ...
      },
      {
        ...
        type: 'Villa',
        status: 'Ready',
        coordinates: { lat: 25.095, lng: 55.156 },
      ...
      },
      {
        ...
        status: 'Off Plan',
        coordinates: { lat: 25.14, lng: 55.35 },
        propertyTypes: ['Townhouse', 'Villa'],
        paymentPlan: [
        ...
        faqs: [
          {
            question: 'What types of properties are available in Nad Al Sheba Gardens?',
            answer: 'Nad Al Sheba Gardens offers a mix of townhouses and villas, with 3, 4, and 5-bedroom options available.'
          },
          {
            question: 'Who is the developer of this project?',
            answer: 'This project is developed by Meraas, one of Dubai\'s leading master developers known for creating premium lifestyle destinations.'
          },
          {
            question: 'Is this a freehold or leasehold community?',
            answer: 'Nad Al Sheba Gardens is a freehold community, allowing 100% foreign ownership.'
          }
        ]
      },
      {
      ...
      },
      {
        ...
        projectStatus: null,
        status: 'Off Plan',
        coordinates: { lat: 25.12, lng: 55.18 },
