...
export const featuredProperties = [
  ...
  {
    id: '3',
    title: '3BR Apartment in Business Bay',
    slug: '3br-apartment-business-bay-damac',
  ...
  {
    id: '6',
    title: '3BR Apartment in DIFC',
    slug: '3br-apartment-difc-index-tower',
...
export const getPropertyData = (id) => {
  ...
  if (property) {
    ...
    return {
      ...
      description: `Modern ${property.type.toLowerCase()} with premium finishes and stunning views. Located in the heart of ${property.address.split(', ')[0]}, this property offers exceptional value for both investment and end-use.`,
      amenities: ['Swimming Pool', 'Gym', 'Security 24/7', 'Covered Parking', 'Children Play Area', 'BBQ Area', 'Concierge', 'Spa'],
      features: ['High Floor', 'Balcony', 'Built-in Wardrobes', 'Central AC', 'Premium Finishes', 'City Views'],
      nearbyPlaces: [
      ...
      developer: { name: 'Emaar', established: 1997, projects: 100 },
      reraPermit: `RERA-${10000 + (Number(id) % 90000)}`,
      completionDate: '2020',
