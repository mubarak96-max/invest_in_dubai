...
export async function generateMetadata({ params }) {
  const blog = await client.fetch(queries.blogBySlug, { slug: params.slug });
  ...
  return {
    ...
    openGraph: {
      title: blog.seoTitle || blog.title,
      description: blog.seoDescription || blog.excerpt,
      images: blog.featuredImage ? [blog.featuredImage.asset.url] : [],
      type: 'article',
...
export default async function BlogDetailPage({ params }) {
  try {
    const [blog, relatedBlogs] = await Promise.all([
      client.fetch(queries.blogBySlug, { slug: params.slug }),
      client.fetch(queries.relatedBlogs, { slug: params.slug })
    ]);
      ...
      <article className="bg-white">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="prose prose-lg max-w-none">
            <PortableText content={blog.content} />
          </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="prose text-gray-700">
                      <PortableText content={blog.author.bio} />
                    </div>
                    ...
                    <article className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                      {relatedBlog.featuredImage && (
                        <div className="relative h-48">
                          <Image
                            src={relatedBlog.featuredImage.asset.url}
